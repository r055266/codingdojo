		...
		<div id="main_content">
			...
			<div id="page_content" class="wrapper profile">
				<div id="message_bar">
					...
					?>
					<form name="new_messages" action="process.php" method="post">
					...
					while($result = $display_message_query->fetch_object())
					{
						if($result->message_id != $previous_message)
						{
							...
							{
								echo '<form name="remove_message" action="process.php" method="post">';
						...
						if($result->comment != NULL && $result->display_comment == 1)
						{
							...
							{
								echo '<form name="remove_comment" action="process.php" method="post">';
